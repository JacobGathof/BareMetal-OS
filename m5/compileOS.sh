...
dd if=picture.txt of=floppya.img bs=512 count=1 seek=30 conv=notrunc
...
bcc -ansi -c -o graphics.o graphics.c
as86 lib.asm -o lib.o
ld86 -o graphics -d graphics.o lib.o
